...
def main(params) :
    ...
    pred = target_model.model.predict(x_test)
    trojannet = TrojanNet()
    ...
    acc_with_backdoor_example = np.mean(np.argmax(pred_with_backdoor_example, axis=1) == y_test)
    acc_with_backdoor_example_backdoor_on = np.mean(np.argmax(pred_with_backdoor_example_backdoor_on, axis=1) == y_test)
    ...
    print(netname)
    print('acc:', acc)
    print('acc_with_backdoor_example:', acc_with_backdoor_example)
    print('acc_with_backdoor_example_backdoor_on:', acc_with_backdoor_example_backdoor_on)
